                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="../images/contact/casa-en-el-valle2.jpg" alt="contact  La casa en el Valle">
                    </div>
                  </div>
              </div>
              <!-- end slider 2 -->
            ...
            <section>
              <div class="container">
                    <div class="">
                      <div class="row">
                        <div class="col-md-12">
                          <h3>Contact La Casa en el Valle</h3>
                          <p>If you are interested in renting la Casa en el Valle, you can contact us by filling in the form below, but you can also email / call or app directly. <br/>
                          </p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-4">
                          <img src="../images/contact/Vivienda-Valle-Lecrín-3.jpg" title="la casa en el valle in the lecrin valley"/>
                        </div>
                        <div class="col-md-4">
                            <p>
                        ...
                        <div class="col-md-4">
                        <img src="../images/contact/Vivienda-Valle-Lecrín-9.jpg" title="la casa en el valle in the lecrin valley"/>
                        </div>
                      </div>
