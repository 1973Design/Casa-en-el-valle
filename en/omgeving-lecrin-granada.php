                        ...
                        <div class="col-md-12 mb-2">
                          <div class="acc-desc">
                            <p><strong> La casa en el valle </strong> is the perfect base for a wonderful holiday! The tranquility that reigns and the various trips you can make in the area, makes this the perfect location for everyone.
                              Below we have made a small summary of the possibilities. But also in the house itself is various information and booklets that can be consulted during the holiday.
                             </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="omgeving-container-parent first">
                          <div class="omgeving-child bg-one">
                            <a href="wandelen-andalusie.php" title="wandelen in Andalusie" class="">To walk</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4">
