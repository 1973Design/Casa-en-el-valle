                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="images/dank/casa-en-el-valle2.jpg" alt="Casa en el Valle">
                    </div>
                  </div>
              </div>
              <!-- end slider 2 -->
                    ...
                    <div class="">
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-2">
                          <div class="acc-desc">
                            <p>Dank voor de aanvraag en interesse in <strong>La Case en el Valle</strong>. We nemen zo snel mogelijk contact op.
                             </p>
                          </div>
                        </div>
                      </div>
